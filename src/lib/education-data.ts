...
export const MODULES: Module[] = [
  ...
  { id: "mod-2-3-4", courseId: "kurs-2-3", title: "Copilot i praktiken", description: "Copilot Basic utan licens, vanliga misstag och rätt verktyg för rätt uppgift.", order: 4, estimatedMinutes: 15, lessonIds: ["les-2-3-4-1", "les-2-3-4-2"], quizQuestionIds: ["aq-2-3-16", "aq-2-3-17", "aq-2-3-18", "aq-2-3-19", "aq-2-3-20"], quizPassThreshold: 0.8 },
