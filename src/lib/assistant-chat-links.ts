...
const DEFAULT_CHAT_LINKS: Record<string, string> = {
  ...
  // Intric Support-kommunanpassad
  "9e588455-1fbd-4a6a-b9dd-e74ad6f23ec0":
    "https://katrineholm.intric.ai/public/91cfdcd1-bb86-4a83-8ac5-9d0dfc945278",
  // VårdKAI (vKAI)
  "45cfade2-7c6e-482c-a1ab-e7f0da85fe54":
    "https://katrineholm.intric.ai/public/3f5b4f92-9202-4b49-a6d4-55bc24faacb6",
  // AI-Vera
